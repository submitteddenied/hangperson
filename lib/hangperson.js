...
function Hangperson(input) {
	if(typeof input == "string") {
		...
		this.wordLength = input.wordLength;
		this.guessed = input.guessed;
		this.guessesRemaining = input.guessesRemaining;
		this.maxGuesses = input.maxGuesses;
	}
}
